...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "نور NOUR — Grown Here. Made for You." },
      {
        name: "description",
        content:
          "مستحضرات جمال طبيعية 100% من تونس. Premium natural cosmetics engineered for Mediterranean skin.",
      },
      { property: "og:title", content: "NOUR — Grown Here. Made for You." },
      {
        property: "og:description",
        content:
          "Premium natural cosmetics from Tunisia, made for Mediterranean skin.",
      },
